...
- Der FFmpeg-Quellcode selbst ist **nicht** Teil dieses Repositories, nur das eigene Build-Rezept (`build-ffmpeg.sh`, `package-ffmpeg-ipk.sh`) und ein eigener Patch:
